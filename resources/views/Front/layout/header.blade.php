<div class="Top-Navbar pt-1 pb-1" id="Top-Navbar">
    <div class="container">

        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand CariaBold delEffect" href="{{route("index")}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="140.462" height="46.445" viewBox="0 0 140.462 46.445">
            ...
            <div class="collapse navbar-collapse d-lg-block d-none" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto ms-xl-5 ms-lg-4 mb-2 mb-lg-0">
                    <div class="d-flex align-items-center justify-content-center SearchSec">
                        <form action="" method="get" class="input-group">
                            <button type="submit" class="bg-none border-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25.794" height="29.41" viewBox="0 0 31.794 35.41">
                                    <g id="Group_52694" data-name="Group 52694" transform="translate(20.157) rotate(60)">
                                        <g id="Ellipse_169" data-name="Ellipse 169" transform="translate(0 0)" fill="none" stroke="#000" stroke-width="1.5">
                                            <circle cx="11.637" cy="11.637" r="11.637" stroke="none"/>
                                            <circle cx="11.637" cy="11.637" r="10.887" fill="none"/>
                                        </g>
                                        <line id="Line_23" data-name="Line 23" x2="5.172" y2="6.465" transform="translate(18.749 20.042)" fill="none" stroke="#000" stroke-linecap="round" stroke-width="1.5"/>
                                    </g>
                                </svg>
                            </button>
                            <input class="form-control Search delEffect me-2 CariaRegular border-0" type="search"
                                   placeholder="بحث .." name="Any" aria-label="Search">
                        </form>
                    </div>
                </ul>
            </div>
            <div class="ms-auto d-flex">
                ...
                <div class="NavTopItems">
                    <ul class="navbar-nav align-items-center flex-row">
                        <li class="nav-item dropdown dropdownSpecial me-lg-0 me-3">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <button type="button" class="delEffect border-0 bg-none position-relative">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20.435" height="19.846" viewBox="0 0 28.435 27.846">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="Chat.html">
                                        <div class="position-relative">
                                            ...
                                            <div class="TypeNotifiction chat d-flex align-items-center justify-content-center">
                                                <i class="fas fa-comment-alt-dots text-white"></i>
                                            </div>
                                        </div>
                                        <span class="CairoSemiBold ms-2">لقد طلب محمود صهيب مراسلتك</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="Chat.html">
                        ...
                        <li class="nav-item dropdown dropdownSpecial dropdownNoticition me-lg-0 me-3">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <button type="button" class="delEffect border-0 position-relative bg-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.784" height="21.586" viewBox="0 0 21.784 27.586">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="DetailProduct.html">
                                        <div class="position-relative">
                                            <img src="img/Public/ss.jpg">
                                            <div class="TypeNotifiction d-flex align-items-center justify-content-center">
                        ...
                        <button class="border-0 delEffect bg-none ChangeMode ms-2 d-lg-block d-none" id="ChangeMode">
                            <i class="far fa-moon"></i>
                        </button>
                        <li class="nav-item dropdown dropdownUser">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{asset('assets/img/user.png')}}">
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item CairoSemiBold" href="{{route('user_Profile')}}">الصفحة الشخصية</a></li>
                                <li><a class="dropdown-item CairoSemiBold" href="{{route('user_logout')}}">تسجيل الخروج</a></li>
                            </ul>
                        </li>
                    </ul>
                    @endauth
                </div>
                <button class="navbar-toggler border-0 delEffect" id="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
...
<div id="NavWeb" class="NavBottom Close pt-2 pb-2">
    <div class="container">
        <div class="SpecialNavMobile d-lg-none d-block">
            <div class="Logo d-flex justify-content-between align-items-center">
                ...
                <div class="Btn-Group">
                    <a class="favorite text-decoration-none " href="Favorite.html">
                        <button type="button" class="delEffect border-0 bg-none position-relative">
                            <i class="fal fa-heart"></i>
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">1</span>
                        </button>
                    </a>
                    <button class="border-0 delEffect bg-none ChangeModeMobile ms-2" id="ChangeModeMobile">
                        <i class="far fa-moon"></i>
                    </button>
                    <button id="CloseNavBar" class="border-0 delEffect bg-none ms-1">
                        <i class="fas fa-times-circle"></i>
                    </button>
                </div>
            </div>
            <div class="d-flex align-items-center justify-content-center SearchSec mb-2 mt-2">
                <form action="" method="get" class="input-group">
                    <button type="submit" class="bg-none border-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20.794" height="24.41" viewBox="0 0 31.794 35.41">
                            <g id="Group_52694" data-name="Group 52694" transform="translate(20.157) rotate(60)">
                                <g id="Ellipse_169" data-name="Ellipse 169" transform="translate(0 0)" fill="none" stroke="#000" stroke-width="1.5">
                                    <circle cx="11.637" cy="11.637" r="11.637" stroke="none"/>
                                    <circle cx="11.637" cy="11.637" r="10.887" fill="none"/>
                    ...
                    <input class="form-control Search bg-none delEffect me-2 CariaRegular border-0" type="search"
                           placeholder="بحث .." name="Any" aria-label="Search">
                </form>
            </div>
            <hr>
        ...
        <div class="d-flex justify-content-between align-items-center Items">
            <ul class="navbar-nav mb-2 mb-lg-0 NeoSansBold flex-row navClass">
                <li class="nav-item">
                    <a class="nav-link CairoSemiBold @if(Route::current()->getName() == "index" ) active  @endif" href="{{route("index")}}">الرئيسية</a>
                </li>
                @include('Front.LandingPage.Menu')
                @if(Auth::guard('user')->check())
                    <li class="nav-item">
                        <a class="nav-link CairoSemiBold @if(Route::current()->getName() == "adds" ) active  @endif" href="{{route("adds")}}">أضف إعلانك</a>
                    </li>
                @endif
                <li class="nav-item">
                    <a class="nav-link CairoSemiBold @if(Route::current()->getName() == "privacy" ) active  @endif" href="{{route("privacy")}}">سياسة الخصوصية</a>
                </li>
                @guest('user')
                <li class="nav-item">
                    <button class="nav-link CairoSemiBold border-0 bg-none " type="button"
...
{{--                @auth('user')--}}
{{--                    <li class="nav-item">--}}
{{--                        <a href="" class="nav-link CairoSemiBold border-0 bg-none " type="button"--}}
{{--                                data-bs-toggle="modal" data-bs-target="#LoginModal"--}}
{{--                        >لوحة التحكم</a>--}}
{{--                    </li>--}}
{{--                @endauth--}}
            ...
            @if(Auth::guard('user')->check())
                <a class="delEffect AddBtn text-decoration-none CairoSemiBold d-lg-block d-none" href="{{route("adds")}}">
